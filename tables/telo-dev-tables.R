...
tbl2flex <- growth_tbl_flex(" ", expo_var, out_var, exposure, outcome, unadj, adj, T)
tbl2supp <- growth_tbl(" ", expo_var, out_var, exposure, outcome, unadj, adj)
tbl2flexsupp <- growth_tbl_flex(" ", expo_var, out_var, exposure, outcome, unadj, adj)
...
expo_var <- c("Telomere length Z-score Year 1") 
out_var <- c("Sitting without support", "Hands-and-knees crawling", "Standing with assistance",
             "Walking with assistance", "Standing alone", "Walking alone")

tbl3 <- hr_tbl(" ", expo_var, out_var, exposure, outcome, HR, HRadj, T)
tbl3flex <- hr_tbl_flex(" ", expo_var, out_var, exposure, outcome, HR, HRadj, T)
tbl3supp <- hr_tbl(" ", expo_var, out_var, exposure, outcome, HR, HRadj)
tbl3flexsupp <- hr_tbl_flex(" ", expo_var, out_var, exposure, outcome, HR, HRadj)
...
tbl4flex <- growth_tbl_flex(" ", expo_var, out_var, exposure, outcome, unadj, adj, T)
tbl4supp <- growth_tbl(" ", expo_var, out_var, exposure, outcome, unadj, adj)
tbl4flexsupp <- growth_tbl_flex(" ", expo_var, out_var, exposure, outcome, unadj, adj)
...
tbl5flex <- growth_tbl_flex(" ", expo_var, out_var, exposure, outcome, unadj, adj, T)
...
save_as_docx("Table 1: Association Between Telomere Length at Year 1 and Child Development" = tbl2flex, 
             ...
             path='C:/Users/Sophia/Documents/WASH/WASH Telomeres and Child Development/telo-dev main tables.docx')
...
save_as_docx("Table 1: Association Between Telomere Length at Year 1 and Child Development" = tbl2flexsupp, 
             ...
             path='C:/Users/Sophia/Documents/WASH/WASH Telomeres and Child Development/telo-dev supplementary tables.docx')
